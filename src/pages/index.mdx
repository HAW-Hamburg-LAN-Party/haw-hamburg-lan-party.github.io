...
Dabei gibt es nicht nur PC-Gaming, sondern auch eine Multiplayer Switch Station, ein VR Station, (Retro-)Konsolen, klassische Table Games und vieles mehr!
...
<div>
### Gewinnspiele & Turnierpreise

Diesmal wird es Gewinnspiele und Turniere geben, bei denen ihr die Chance habt Preise zu gewinnen.
<br/>
Weitere Informationen zu den Preisen und Gewinnspielen werden noch bekannt gegeben.
...
<div class="row">
	<a href="https://asta.haw-hamburg.de" target="_blank"><Image src={asta} alt="Sponsor: AStA der HAW Hamburg" loading="lazy" class="h-30" /></a>
